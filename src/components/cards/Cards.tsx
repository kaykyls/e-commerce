    ...
    return (
        <div className="cards-container container-sm">
            ...
            <div className="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-2 g-sm-3">
                ...
                <Card title={"Nike 3"} rating={1} previousPrice={199.99} currentPrice={39.99} image={"https://images.unsplash.com/photo-1608363789638-70e879a9d988?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"}/>
